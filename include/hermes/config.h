...
--------------------------------------------------*/
#define MAX_MACHINE_NUM          7 // maximum nodes
...
-------------------------------------------------
--------------------------------------------------*/
#define ENABLE_LAST_BUFF_WRITE
#define ENABLE_READ_BUFFER

//#define ENABLE_ASYNC_ONLY_READS
#ifdef ENABLE_ASYNC_ONLY_READS
# define _ST_GET_COMPLETE ST_GET_ASYNC_COMPLETE
#else
# define _ST_GET_COMPLETE ST_GET_COMPLETE
#endif
