...
declare -a num_workers=(8)
#declare -a num_workers=(1 2 4 8)
#declare -a batch_sizes=(25 50 75 100 125 150 200 250)
#declare -a num_machines=(3 5 7)
declare -a num_machines=(5)

# Config for low write rate
declare -a batch_sizes=(200)
declare -a credits=(10)
declare -a coalesce=(10)
declare -a write_ratios=(10 20)

#declare -a batch_sizes=(250)
#declare -a credits=(50)
#declare -a coalesce=(25)
#declare -a write_ratios=(50)

# Config for high write rate
#declare -a batch_sizes=(250)
#declare -a credits=(75)
#declare -a coalesce=(25)
